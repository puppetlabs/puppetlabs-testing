...
group :system_tests do
  ...
  gem "beaker-rspec"
  gem "github_changelog_generator",                              require: false, git: 'https://github.com/skywinder/github-changelog-generator', ref: 'testsha' if Gem::Version.new(RUBY_VERSION.dup) >= Gem::Version.new('2.2.2')
end
